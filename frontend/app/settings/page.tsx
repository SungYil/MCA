                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className="px-4 py-2 rounded-lg text-sm font-bold text-red-400 hover:bg-red-500/10 border border-transparent hover:border-red-500/20 transition-all"
                        >
                            Logout
                        </button>
                        <button onClick={() => router.push('/')} className="text-gray-400 hover:text-white px-4 py-2">
                            ← Back to Dashboard
                        </button>
                    </div>
                </div>
